...
## Описание 
Нейрописатель  филосовских историй о перепрошивке твоего сознания с использованием OpenAI API. Пользователь выбирает тему или описывает свою проблему, выбирает формат повествования и стиль автора и в результате получает сгенерированный историю.
