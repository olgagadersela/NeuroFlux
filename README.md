...
**Описание:**  
Бот для создания эпизодов сторий с использованием OpenAI API. Пользователь выбирает тему повествования, формат повестваования и стиль автора и получает сгенерированный текст.  [Попробовать здесь] (https://t.me/chitchattering_bot)
